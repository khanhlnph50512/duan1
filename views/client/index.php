               ...
               <div class="tp-product-item p-relative transition-3 mb-25">
                  ...
                  <div class="tp-product-content">
                     ...
                     <div class="tp-product-price-wrapper">
                        <?php if ($product['product_sale_price'] < $product['product_price']): ?>
                           <span
                              class="tp-product-price old-price"><?php echo number_format($product['product_price'], 0, ',', '.'); ?>
                              VNĐ</span>
                           <span
                              class="tp-product-price new-price"><?php echo number_format($product['product_sale_price'], 0, ',', '.'); ?>
                              VNĐ</span>
                        <?php else: ?>
                           <span class="tp-product-price"><?php echo number_format($product['product_price'], 0, ',', '.'); ?>
                              VNĐ</span>
                        <?php endif; ?>
                     </div>
                  </div>

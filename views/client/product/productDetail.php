         ...
         <div class="col-xxl-12">
            <div class="breadcrumb__content p-relative z-index-1">
               <div class="breadcrumb__list has-icon">
                  ...
                  <span><a href="http://localhost/DU_AN_1%20NHOM3/public/">Home</a></span>
         ...
         <div class="row">
               ...
               <div class="tp-product-details-thumb-wrapper tp-tab d-sm-flex">
                  <nav>
                     <div class="nav nav-tabs flex-sm-column " id="productDetailsNavThumb" role="tablist">
                        ...
                        <button class="nav-link <?=$key===0 ? 'active' : ''?>" id="nav-<?=$key+1?>-tab" data-bs-toggle="tab" data-bs-target="#nav-<?=$key+1?>"
                         type="button" role="tab" aria-controls="nav-<?=$key+1?>" aria-selected="<?=$key===0 ?'true' : 'false'?>">
            ...
            <div class="col-xl-5 col-lg-6">
               ...
               <div class="tp-product-details-wrapper">
                  <input type="text" name="product_id" value="<?=$productDetail['product_id']?>">
                  <div class="tp-product-details-category">
                     <span><?= $productDetail['category_name']?></span>
                  </div>
                  <h3 class="tp-product-details-title"><?= $productDetail['product_name']?></h3>
                  ...
                  <p><?=$productDetail['product_description']?> ...<span>See more</span></p>

                  <!-- price -->
                  <div class="tp-product-details-price-wrapper mb-20">
                     <span class="tp-product-details-price old-price price-variants"><?=number_format($productDetail['product_price']*1000,0,',','.')?>vnd</span>
                     <span class="tp-product-details-price new-price sale-price-variants"><?=number_format($productDetail['product_sale_price']*1000,0,',','.')?>vnd</span>
                  ...
                  <div class="tp-product-details-variation">
                     ...
                     <div class="tp-product-details-variation-item">
                        ...
                        <?php foreach($productDetail['variants'] as $variant) : ?>
                           <button type="button" class="color tp-color-variation-btn btn-color" data-color="<?=$variant['variant_color_code']?>">
                              <span data-bg-color="<?=$variant['variant_color_code']?>" class="border"></span>
                              <span class="tp-color-variation-tootltip"><?=$variant['variant_color_name']?></span>
                           </button>
                           <?php endforeach; ?>
                        </div>
                     </div>
                     ...
                     <div class="tp-product-details-variation-item">
                        ...
                        <div class="tp-product-details-variation-list">
                        <?php foreach($productDetail['variants'] as $variant) : ?>
                           <button type="button" class=" tp-size-variation-btn btn-size" data-size="<?=$variant['variant_size_name']?>">
                  ...
                  <div class="tp-product-details-action-wrapper">
                     ...
                     <div class="tp-product-details-action-item-wrapper d-flex align-items-center">
                        ...
                        <div class="tp-product-details-add-to-cart mb-15 w-100">
                           <button name="add_to_cart"class="tp-product-details-add-to-cart-btn w-100">Add To Cart</button>
                        </div>
                     </div>
                     <button class="tp-product-details-buy-now-btn w-100"name="buy_now">Buy Now</button>
                  </div>
                              ...
                              <div class="col-xl-10">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-lg-6">
                                          <div class="tp-product-details-desc-thumb">
                                             <img src="client/assets/img/product/details/desc/product-details-desc-1.jpg" alt="">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
                                 <div class="tp-product-details-desc-item  pb-75">
                                    <div class="row">
                                       ...
                                       <div class="col-lg-7">
                                          <div class="tp-product-details-desc-thumb">
                                             <img src="client/assets/img/product/details/desc/product-details-desc-2.jpg" alt="">
                                          </div>
                                       </div>
                                    ...
                                    <div class="row">
                                       <div class="col-xl-12">
                                          <div class="tp-product-details-desc-banner text-center m-img">
                                             ...
                                             <img src="client/assets/img/product/details/desc/product-details-desc-3.jpg" alt="">
                                          </div>
                                       </div>
                                    </div>
                                 </div>
               ...
               <div class="swiper-wrapper">
                     ...
                     <div class="tp-product-item-3 tp-product-style-primary mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details.html">
                              <img src="client/assets/img/product/related/product-related-1.jpg" alt="">
                           </a>
                  ...
                  <div class="swiper-slide">
                     <div class="tp-product-item-3 tp-product-style-primary mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details.html">
                              <img src="client/assets/img/product/related/product-related-2.jpg" alt="">
                           </a>
                  ...
                  <div class="swiper-slide">
                     <div class="tp-product-item-3 tp-product-style-primary mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details.html">
                              <img src="client/assets/img/product/related/product-related-3.jpg" alt="">
                           </a>
                  ...
                  <div class="swiper-slide">
                     <div class="tp-product-item-3 tp-product-style-primary mb-50">
                        <div class="tp-product-thumb-3 mb-15 fix p-relative z-index-1">
                           <a href="product-details.html">
                              <img src="client/assets/img/product/related/product-related-4.jpg" alt="">
                           </a>
...
<script>
   document.addEventListener('DOMContentLoaded', function(){
      ...
      // lay va chuyen du lieu cua php  sang javascript
      const variants = <?=json_encode($productDetail['variants'])?>;
       ...
       // xu ly su kien khi nguoi dung chon mau
      ...
      function checkPrice(){
         ...
         document.getElementById('#variant_id').value =''        ; 
            ...
            // cap nhat mau kha dung
            function updateColor(){
               colorButtons.forEach(button =>{
                  const color = button.getAttribute('data-color');
                  //kiem tra kich thuoc da chon co mau nay khong
            ...
            function updateSize(){
               sizeButtons.forEach(button =>{
                  ...
                  button.disable = !isAvailable; // neu khong ton tai khong cho chon
                  if(!isAvailable){

 ...
 <footer>
                     ...
                     <div class="row align-items-center">
                        ...
                        <div class="col-md-6">
                           <div class="tp-footer-payment text-md-end">
                              <p>
                                 <img src="client/assets/img/footer/footer-pay.png" alt="">
                              </p>
                           </div>
                        </div>
                     </div>
      ...
      <!-- JS here -->
      <script src="client/assets/js/vendor/jquery.js"></script>
      <script src="client/assets/js/vendor/waypoints.js"></script>
      <script src="client/assets/js/bootstrap-bundle.js"></script>
      <script src="client/assets/js/meanmenu.js"></script>
      <script src="client/assets/js/swiper-bundle.js"></script>
      <script src="client/assets/js/slick.js"></script>
      <script src="client/assets/js/range-slider.js"></script>
      <script src="client/assets/js/magnific-popup.js"></script>
      <script src="client/assets/js/nice-select.js"></script>
      <script src="client/assets/js/purecounter.js"></script>
      <script src="client/assets/js/countdown.js"></script>
      <script src="client/assets/js/wow.js"></script>
      <script src="client/assets/js/isotope-pkgd.js"></script>

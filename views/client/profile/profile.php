                                                ...
                                                <div class="col-md-6">
                                                    <div
                                                        ...
                                                        <div class="profile__main-content">
                                                            <h4 class="profile__main-title">Xin chào
                                                                <?= $_SESSION['user']['name'] ?>
                                                            </h4>
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            ...
                                                            <?php if (isset($_SESSION['errors']['gender'])): ?>
                                                                <p class="text-danger"><?= $_SESSION['errors']['gender'] ?>
                                                                </p>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-xxl-12">
                                                        <div class="profile__btn">
                                                            <button type="submit" name="update-profile"
                                                                class="tp-btn">Update Profile</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <div class="profile__notification-wrapper">
                                            ...
                                            <div class="profile__notification-item mb-20">
                                                <div class="form-check form-switch d-flex align-items-center">
                                                    <input class="form-check-input" type="checkbox" role="switch"
                                                        id="post" checked>
                                                    <label class="form-check-label" for="post">Post, Comments & Replies
                                                        Notifications</label>
                                                </div>
                                            </div>
                                            <div class="profile__notification-item mb-20">

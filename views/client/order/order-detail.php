            ...
            <div class="card-body">
                <table class="table table-bordered mb-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                            // Cộng tổng tiền với phí vận chuyển
                            $totalAmount = $orderDetail['amount']*1000 + $orderDetail['shipping_price'];

                            // Hiển thị tổng tiền (không cần nhân với 1000 nếu đã là số tiền thực tế)
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?= number_format($price * 1000, 0, ',', '.') ?> vnđ</td>
                    <td><?= $item['quantity'] ?></td>
                </tr>
            <?php endforeach; ?>
        </tbody>

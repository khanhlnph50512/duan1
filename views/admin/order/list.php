                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>
                                                            <div class="d-flex gap-2">
                                                                 ...
                                                                 <a href="?act=orderAdmin-detail&order_detail_Id=<?= $order['order_detail_Id'] ?>" class="btn btn-soft-info btn-sm">
                                                                      <iconify-icon icon="material-symbols:visibility" class="align-middle fs-18"></iconify-icon> Xem chi tiết
                                                                 </a>
                                                            </div>
                                                       </td>
                                                  </tr>

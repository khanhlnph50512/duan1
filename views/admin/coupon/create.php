                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="mb-3">
                                     ...
                                     <input type="text" id="start-date" class="form-control flatpickr-input active" name="start_date" placeholder="yyyy-mm-dd" >
                                </div>
                                ...
                                <div class="mb-3">
                                     ...
                                     <input type="text" id="end-date" class="form-control flatpickr-input active" name="end_date" placeholder="yyyy-mm-dd" >
                                </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="mb-3">
                                        ...
                                        <input type="text" id="coupons-limits" name="coupon_code" class="form-control" placeholder=" ma giam gia">
                                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="coupons-limits" name="quantity" class="form-control" placeholder="Nhập số lượng">
                                   </div>
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="coupon_type" value="Pencentage" id="flexRadioDefault13">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="coupon_type" value="Fixed Amout"id="flexRadioDefault14">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="">
                                        ...
                                        <input type="text" id="discount-value" name="coupon_value" class="form-control" placeholder="Nhập giá trị">
                                   </div>

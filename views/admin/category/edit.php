                                   ...
                                   <div class="row">
                                        <div class="col-lg-6">
                                             ...
                                             <div class="mb-3">
                                                  ...
                                                  <input type="text" id="meta-title" name="name" class="form-control" value="<?=$getCategory['name']?>"
                                        ...
                                        <div class="col-lg-6">
                                             ...
                                             <select class="form-control" id="crater" name="status" data-choices
                                        ...
                                        <div class="col-lg-12">
                                             <div class="mb-0">
                                                  ...
                                                  <textarea class="form-control bg-light-subtle" name="description"
                                                       id="description" rows="4" placeholder="Nhập mô tả"><?=$getCategory['description']?></textarea>
                                             </div>

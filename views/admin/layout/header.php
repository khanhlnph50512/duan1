...
<!-- Mirrored from techzaa.in/larkon/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 23 Nov 2024 16:06:19 GMT -->
<head>
     <!-- Title Meta -->
     <meta charset="utf-8" />
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarOrders">
                                   <ul class="nav sub-navbar-nav">
                                        ...
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="?act=order_status">List</a>
                                        </li>
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarRoles">
                                   <ul class="nav sub-navbar-nav">
                                        <ul class="nav sub-navbar-nav">
                                             <li class="sub-nav-item">
                                                  <a class="sub-nav-link" href="index.php?act=role-list">List</a>
                                             </li>
                         ...
                         <li class="nav-item">
                              ...
                              <div class="collapse" id="sidebarCoupons">
                                   <ul class="nav sub-navbar-nav">
                                        <li class="sub-nav-item">
                                             <a class="sub-nav-link" href="index.php?act=coupon-list">List</a>
                                        </li>
                                        <li class="sub-nav-item">

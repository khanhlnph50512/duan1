                                        ...
                                        <div class="col-lg-6">
                                             ...
                                             <div class="mb-3">
                                                  <label for="product_sale_price" class="form-label">Giá khuyến
                                                       mãi</label>
                                                  <input type="text" id="product_sale_price" name="product_sale_price"
                                        ...
                                        <div class="row mb-4 mt-3  border rounded px-2">
                                                       ...
                                                       <div class="d-flex flex-wrap gap-2" role="group"
                                                            ...
                                                            <?php foreach ($listSizes as $size): ?>
                                                                 <input type="checkbox" class="btn-check"
                                                                      ...
                                                                      id="size-<?= $size['variant_size_Id'] ?>"
                                                                      name="variant_size[]">
                                                                 <label
                                                                      class="btn btn-light avatar-sm rounded d-flex justify-content-center align-items-center"
                                                                      for="size-<?= $size['variant_size_Id'] ?>"><?= $size['size_name'] ?></label>
                                                            <?php endforeach; ?>
                                                  ...
                                                  <div class="mt-3 mb-3">
                                                       ...
                                                       <div class="d-flex flex-wrap gap-2" role="group"
                                                            ...
                                                            <?php foreach ($listColors as $color): ?>
                                                                 <input type="checkbox" class="btn-check"
                                                                      id="color-<?= $color['variant_color_Id'] ?>"
                                                                      value="<?= $color['variant_color_Id'] ?>"
                                                                      name="variant_color[]">
                                                                 <label
                                                                      class="btn btn-light avatar-sm rounded d-flex justify-content-center align-items-center"
                                                                      for="color-<?= $color['variant_color_Id'] ?>"> <i
                                             ...
                                             <div class="col-lg-3">
                                                  ...
                                                  <div class="mt-3 mb-3">
                                                       ...
                                                       <input type="text" id="variant_quantity[]"
                              ...
                              <div class="row justify-content-end g-2">
                                   <div class="col-lg-2">
                                        <button type="submit" name="add_products"
                                             class="btn btn-outline-secondary w-100">Thêm mới sản phẩm</button>
                                   </div>
                                   <div class="col-lg-2">

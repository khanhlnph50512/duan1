          ...
          <div class="col-xl-12">
               <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                         ...
                         <a href="?act=product-create" class="btn btn-sm btn-primary">
                              Thêm mới sản phẩm
                         </a>
                              ...
                              <table class="table align-middle mb-0 table-hover table-centered">
                                   <thead class="bg-light-subtle">
                                        <tr>
                                             ...
                                             <th>Tên sản phẩm vào biến thể</th>
                                             <th>Giá sản phẩm</th>
                                   ...
                                   <tbody>
                                        ...
                                        <tr>
                                             ...
                                             <td><?=number_format($product['product_price'] * 1000,0,',','.')?>vnd</td>
                                             <td><?=number_format($product['product_sale_price'] * 1000,0,',','.')?>vnd</td>
